...
// Interface que coincide exactamente con la estructura de PRODUCT_DATA
interface ProductDataItem {
  ...
  overallWidth: string;
  fifthWheelHeight: string;
  rearDeckHeight: string;
  kingpinLocation: string;
  landingGearLocation: string;
  axleSpread: string;
  tareWeight: string;
  payload: string;
...
{
    name: "33' Slider Triaxle Container Chassis",
