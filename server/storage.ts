...
const PRODUCT_DATA = [
  ...
  {
    name: "20' SL Tandem Container Chassis - Español",
    nameEs: "Chasis Contenedor Tandem 20' SL",
    slug: "20-sl-tandem-esp",
    conditionId: 1,
    manufacturer: "AXN",
    size: "20ft",
    axleConfig: "Tandem",
    description: "Lightweight tandem axle chassis specifically designed for 20-foot containers with superior maneuverability.",
    descriptionEs: "Chasis tándem ligero específicamente diseñado para contenedores de 20 pies con maniobrabilidad superior.",
    imageUrl: "/assets/20-sl-tandem-esp.webp",
    additionalImages: [
      "/assets/20_SL_Tandem_2.jpg",
      "/assets/20_SL_Tandem_3.jpg"
    ],
  ...
  },
  {
    ...
    imageUrl: "/assets/used-40-gooseneck-chassis-refurbished.webp",
    additionalImages: [],
    overallLength: "40'-11''",
    overallWidth: "96''",
    fifthWheelHeight: "48±1''",
  ...
  {
    name: "Used 20' SL Tandem Container Chassis Refurbished",
    nameEs: "Chasis Contenedor Tandem 20' SL Usado Reacondicionado",
    slug: "used-20-sl-tandem-container-chassis-refurbished",
    conditionId: 2,
    manufacturer: "AXN",
    size: "20ft",
    axleConfig: "Tandem",
    ...
    imageUrl: "/assets/used-20-sl-tandem-container-chassis-refurbished.webp",
    additionalImages: [],
    overallLength: "31'-6''",
    overallWidth: "96''",
    fifthWheelHeight: "47±1''",
  ...
  {
    name: "Used 20/40' 12 Pins Triaxle Container Chassis Refurbished",
    nameEs: "Chasis Contenedor Triaxial 20/40' 12 Pines Usado Reacondicionado",
    slug: "used-20-40-12-pins-triaxle-container-chassis-refurbished",
    conditionId: 2,
    manufacturer: "AXN",
    size: "20-40ft",
    axleConfig: "Triaxle",
    ...
    imageUrl: "/assets/used-20-40-12-pins-triaxle-container-chassis-refurbished.webp",
    additionalImages: [],
    overallLength: "31'-7'' (retracted) or 40'-11'' (extended)",
    overallWidth: "96''",
    fifthWheelHeight: "47±1''",
