      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className={className}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="font-montserrat">{t('fullName')}</FormLabel>
                <FormControl>
                  <Input 
                    {...field} 
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="font-montserrat">{t('emailAddressLabel')}</FormLabel>
                <FormControl>
                  <Input 
                    {...field} 
                    type="email"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="font-montserrat">{t('companyName')}</FormLabel>
                <FormControl>
                  <Input 
                    {...field} 
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="font-montserrat">{t('phoneNumberLabel')}</FormLabel>
                <FormControl>
                  <Input 
                    {...field} 
                    type="tel"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="font-montserrat">{t('interestedIn')}</FormLabel>
                <Select 
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="font-montserrat">{t('numberOfUnits')}</FormLabel>
                <FormControl>
                  <Input 
                    {...field} 
                    type="number"
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="mb-6">
              <FormLabel className="font-montserrat">{t('message')}</FormLabel>
              <FormControl>
                <Textarea 
                  {...field} 
                  rows={4}
