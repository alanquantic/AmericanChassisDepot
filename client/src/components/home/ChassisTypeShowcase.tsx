...
const ChassisTypeShowcase: React.FC = () => {
  ...
  const renderChassisCards = () => {
    const filteredConditions = conditions.filter((condition) => condition.slug !== 'chassis-nuevos-espanol');
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {isLoading ? renderLoadingSkeletons() : 
           conditions.length > 0 ? renderChassisCards() : 
           renderEmptyState()}
        </div>
      </div>
    </section>
